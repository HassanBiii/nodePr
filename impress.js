...
(function(document) {
  ...
  var addNavigationControls = function(event) {
    ...
    var prevHtml =
      ...
      'class="impress-navigation-ui">Prev</button>';
    var selectHtml =
    ...
    var nextHtml =
      ...
      'class="impress-navigation-ui">Next</button>';
...
(function(document) {
  ...
  function updateProgressbar(slideId) {
    ...
    if (null !== progressbar) {
      var height = (100 / (stepids.length - 1)) * slideNumber;
      progressbar.style.height = height.toFixed(2) + "%";
    }
    if (null !== progress) {
